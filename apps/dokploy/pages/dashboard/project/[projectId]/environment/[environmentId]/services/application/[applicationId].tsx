	...
	return (
		<div className="pb-10">
			...
			<div className="w-full">
				<Card className="gh-surface w-full rounded-lg">
					<CardHeader className="flex flex-row justify-between items-start gap-4 px-6 py-5">
						<div className="flex flex-col gap-1">
							<span className="gh-eyebrow">{data?.appName}</span>
							<CardTitle className="text-lg font-semibold tracking-tight flex flex-row gap-3 items-center">
						...
						<div className="flex flex-col h-fit w-fit gap-2 items-end">
							<div className="flex flex-row h-fit w-fit gap-2 items-center">
								<Badge
									variant="outline"
									className={cn(
										"gh-interactive cursor-pointer border-border bg-transparent font-normal text-muted-foreground hover:text-foreground",
										data?.serverId &&
					...
					<CardContent className="space-y-2 px-6 py-6 border-t border-border">
						{data?.server?.serverStatus === "inactive" ? (
							<div className="flex h-[55vh] border rounded-lg border-dashed border-border p-4">
							...
							>
								<div className="flex flex-row items-center justify-between w-full overflow-auto">
									<TabsList className="flex w-full gap-6 max-md:gap-4 justify-start">
